...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/healthz.ts",
			"pathname": "/healthz",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/matchplay/new.astro",
			"pathname": "/matchplay/new",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/matchplay/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/matchplay/index.astro",
			"pathname": "/matchplay",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/node_DfvdAmqQ.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/healthz_BwSun7aQ.mjs");
var _page2 = () => import("./chunks/new_CzksQbkq.mjs");
var _page3 = () => import("./chunks/_id__DWG4H1Ep.mjs");
var _page4 = () => import("./chunks/index_DaKCw07F.mjs");
var _page5 = () => import("./chunks/readyz_B6qfSHPp.mjs");
var _page6 = () => import("./chunks/index_B1wpbRrz.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["../node_modules/astro/dist/assets/endpoint/node.js", _page0],
	["src/pages/healthz.ts", _page1],
	["src/pages/matchplay/new.astro", _page2],
	["src/pages/matchplay/[id].astro", _page3],
	["src/pages/matchplay/index.astro", _page4],
	["src/pages/readyz.ts", _page5],
	["src/pages/index.astro", _page6]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/","cacheDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/node_modules/.astro/","outDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/dist/","srcDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/src/","publicDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/public/","buildClientDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/dist/client/","buildServerDir":"file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/dist/server/","adapterName":"@astrojs/node","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"../node_modules/astro/dist/assets/endpoint/node.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/healthz","isIndex":false,"type":"endpoint","pattern":"^\\/healthz\\/?$","segments":[[{"content":"healthz","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/healthz.ts","pathname":"/healthz","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/PageHeader.byiZg-1U.css"},{"type":"inline","content":".pair[data-astro-cid-bkeu3kzs]{grid-template-columns:repeat(auto-fit,minmax(12rem,1fr));gap:1rem;display:grid}form[data-astro-cid-bkeu3kzs]{max-width:34rem}\n"}],"routeData":{"route":"/matchplay/new","isIndex":false,"type":"page","pattern":"^\\/matchplay\\/new\\/?$","segments":[[{"content":"matchplay","dynamic":false,"spread":false}],[{"content":"new","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/matchplay/new.astro","pathname":"/matchplay/new","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/PageHeader.byiZg-1U.css"},{"type":"inline","content":"h2[data-astro-cid-eqfns3pq]{font-family:var(--font-serif);margin:0;font-size:1.2rem}.right[data-astro-cid-eqfns3pq]{text-align:right}.right[data-astro-cid-eqfns3pq] form[data-astro-cid-eqfns3pq]{display:inline}.add[data-astro-cid-eqfns3pq]{flex-wrap:wrap;align-items:flex-end;gap:.75rem;display:flex}.add[data-astro-cid-eqfns3pq] .field[data-astro-cid-eqfns3pq]{flex:1;min-width:16rem}h2[data-astro-cid-joqibaeh]{font-family:var(--font-serif);margin:0;font-size:1.2rem}h3[data-astro-cid-joqibaeh]{font-family:var(--font-score);text-transform:uppercase;letter-spacing:.1em;color:var(--text-dim);margin:0 0 .6rem;font-size:.75rem}.round[data-astro-cid-joqibaeh]+.round[data-astro-cid-joqibaeh]{margin-top:1.5rem}.matches[data-astro-cid-joqibaeh]{grid-template-columns:repeat(auto-fill,minmax(19rem,1fr));gap:.75rem;display:grid}.match[data-astro-cid-joqibaeh]{flex-direction:column;gap:.6rem;padding:.85rem 1rem;display:flex;position:relative}.match[data-astro-cid-joqibaeh].waiting{opacity:.6}.match[data-astro-cid-joqibaeh].decided .players[data-astro-cid-joqibaeh] span[data-astro-cid-joqibaeh]:not(.won):not(.v){color:var(--text-dim)}.players[data-astro-cid-joqibaeh]{grid-template-columns:1fr auto 1fr;align-items:baseline;gap:.5rem;font-size:.95rem;display:grid}.players[data-astro-cid-joqibaeh] span[data-astro-cid-joqibaeh]:last-of-type{text-align:right}.won[data-astro-cid-joqibaeh]{color:var(--matchplay);font-weight:600}.v[data-astro-cid-joqibaeh]{color:var(--text-faint);font-size:.8rem}.result[data-astro-cid-joqibaeh]{text-align:center;margin:0}.hint[data-astro-cid-joqibaeh]{color:var(--text-dim);font-size:.78rem;font-family:var(--font-num);margin:0}.record[data-astro-cid-joqibaeh]{border-top:1px solid var(--line);grid-template-columns:1fr 1fr auto;align-items:end;gap:.5rem;padding-top:.6rem;display:grid}.mid[data-astro-cid-joqibaeh]{font-family:var(--font-num);color:var(--text-faint);font-size:.65rem;position:absolute;top:.5rem;right:.65rem}h2[data-astro-cid-h2evdhk2]{font-family:var(--font-serif);margin:0;font-size:1.2rem}.draw[data-astro-cid-h2evdhk2],.reopen[data-astro-cid-h2evdhk2]{border-top:1px solid var(--line);padding-top:1.5rem}.hint[data-astro-cid-h2evdhk2]{color:var(--text-dim);font-size:.8rem}\n"}],"routeData":{"route":"/matchplay/[id]","isIndex":false,"type":"page","pattern":"^\\/matchplay\\/([^/]+?)\\/?$","segments":[[{"content":"matchplay","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/matchplay/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/PageHeader.byiZg-1U.css"}],"routeData":{"route":"/matchplay","isIndex":true,"type":"page","pattern":"^\\/matchplay\\/?$","segments":[[{"content":"matchplay","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/matchplay/index.astro","pathname":"/matchplay","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/readyz","isIndex":false,"type":"endpoint","pattern":"^\\/readyz\\/?$","segments":[[{"content":"readyz","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/readyz.ts","pathname":"/readyz","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/PageHeader.byiZg-1U.css"},{"type":"inline","content":".sections[data-astro-cid-lcdefpme]{grid-template-columns:repeat(auto-fit,minmax(16rem,1fr));gap:1rem;display:grid}.section-card[data-astro-cid-lcdefpme]{flex-direction:column;gap:.4rem;padding:1.1rem 1.25rem;display:flex}.section-card[data-astro-cid-lcdefpme] h2[data-astro-cid-lcdefpme]{flex-wrap:wrap;align-items:center;gap:.6rem;margin:0;font-size:1.05rem;display:flex}.section-card[data-astro-cid-lcdefpme] p[data-astro-cid-lcdefpme]{color:var(--text-muted);margin:0;font-size:.9rem}.section-card[data-astro-cid-lcdefpme].soon{opacity:.6}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/src/pages/matchplay/[id].astro",{"propagation":"none","containsHead":true}],["/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/src/pages/matchplay/index.astro",{"propagation":"none","containsHead":true}],["/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/src/pages/matchplay/new.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_DS5V7T-N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/node/server.js":"entry.mjs","\u0000virtual:astro:page:src/pages/matchplay/[id]@_@astro":"chunks/_id__DWG4H1Ep.mjs","\u0000virtual:astro:page:src/pages/healthz@_@ts":"chunks/healthz_BwSun7aQ.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_B1wpbRrz.mjs","\u0000virtual:astro:page:src/pages/matchplay/index@_@astro":"chunks/index_DaKCw07F.mjs","\u0000virtual:astro:page:src/pages/matchplay/new@_@astro":"chunks/new_CzksQbkq.mjs","\u0000virtual:astro:page:../node_modules/astro/dist/assets/endpoint/node@_@js":"chunks/node_DfvdAmqQ.mjs","\u0000virtual:astro:page:src/pages/readyz@_@ts":"chunks/readyz_B6qfSHPp.mjs","/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_CfVbj0z2.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/_astro/PageHeader.byiZg-1U.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"R+jjsiqsP8d7WhmMHYRpk743T3QEH2tPQMgfLjbeSew=","sessionConfig":{"driver":"unstorage/drivers/fs-lite","options":{"base":"/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/node_modules/.astro/sessions"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var mode = "standalone";
var client = "file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/dist/client/";
var server = "file:///Users/lkoskela/OSS/hectorgolf/hector.golf/.claude/worktrees/json-turso-migration-ca756d/admin/dist/server/";
var port = 4321;
