...
| `check-markdown.yml` | PRs targeting `main` touching any `**/*.md`, `.markdownlint-cli2.jsonc`, the root lockfile, or this file | root-only `npm ci` → `npm run lint:md` over every `.md` in the repository | `contents: read` |
