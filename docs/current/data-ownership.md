...
is no longer needed. Since step 3 of
[`handicaps-to-firestore.md`](../plans/handicaps-to-firestore.md) the site reads the observation log
directly, so a copy of the latest reading in a player's file is a second source of truth for a
question already answered. Forty files carried one; they no longer do.
