...
| `player.handicap` | Derived, with a stopgap | CI | The best known handicap. CI writes it whenever WiseGolf has one; a person fills it when WiseGolf does not, and CI supersedes that as soon as it can |
